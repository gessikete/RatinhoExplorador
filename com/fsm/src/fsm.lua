...
local function build_transition(self, event, states, next_event)
  return function (...)
...
function M.create(cfg, target)
  ...
  local function add(e)
    ...
    next_event[event] = next_event[event] or {}
  ...
  for event, states in pairs(states_for_event) do
    self[event] = build_transition(self, event, states, next_event)
  end
